...
_prompt_time="$(_prompt_colour red)\A$(_prompt_colour default)"
...
_prompt_rvm_interpreter="$(_prompt_colour white)using \$(__bash_rvm_prompt_additions)$(_prompt_colour default)"
